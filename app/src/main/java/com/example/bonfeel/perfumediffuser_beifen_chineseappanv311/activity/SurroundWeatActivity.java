 ...
 * Author:FunFun
 * Function:
 * Date:2016/4/12 13:41
 */
public class SurroundWeatActivity extends BaseActivity
{
    ...
    {
        setContentView(R.layout.activity_surround_weat);
    ...
    protected void initialData()
    {
        ...
        weatCast = new IntentFilter();
        weatCast.addAction(NetElectricsConst.ACTION_CHECK_TEMPWEAT);
        registerReceiver(broadcastReceiver, weatCast);
        if (NetCommunicationUtil.getNetConnectState()) {
            ...
            dialog.dismiss();
            ToastUtil.showToast(SurroundWeatActivity.this, "请确保网络正确连接!");
        }
    }
    /**
     * 方法名称：	queryWeat
     ...
     * 参数：
     * 返回值类型：	void
     * 创建时间：	2015-3-31下午9:02:52
     */
    private void queryWeat()
    {
        NetCommunicationUtil.queryDevice(
                BonfeelFrame.queryWeat,
                device.getMac(),
     ...
     * 参数：
     * 返回值类型：	void
     * 创建时间：	2015-3-31下午9:03:34
     */
    private void reCheckWeat()
    {
    ...
    protected void initialView()
    {
        ...
        tvWeat = (TextView)findViewById(R.id.tv_show_weat);
        tvTag = (TextView)findViewById(R.id.tv_weat_tag);
